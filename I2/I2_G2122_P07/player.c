...
/* It gets the health value of  Player */
int  player_get_health( Player*  ply){
...
/* It sets the health value of  player */
STATUS  player_set_health( Player*  ply, int hlt) {
