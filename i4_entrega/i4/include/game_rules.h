...
typedef enum enum_Rules {
  NO_RULE = -1,     /*!< NO RULE*/ 
  ENEMY,            /*!< RESPAWN ENEMY*/
  ENEMY_LOC,        /*!< ENEMY CHANGE LOCATION*/
  ROCK,             /*!< ROCKS HITS PLAYER*/
  OBJ_OFF,          /*!< OBJECT TURNS OFF RANDOMLY*/
  OBJ_DROP,         /*!< OBJECT DROPS RANDOMLY*/
  PARALIZED         /*!< PLAYER IS PARALIZED A FEW TURNS*/
} T_Rules;
...
/**
  * @brief It selects a random rule
  * @author Joaquin Abad
  *
  * 
  * @param n random number
  * @return The randoom rule
  */
