 ...
 *
 * @param space pointer to the space struct
 * @param desc a pointer to description
 * @return OK, if everything goes well or ERROR if there was some mistake
 */
 ...
 * @return the description that we want or NULL if something goes wrong
 */
 ...
 * @author Oskar
 *
 * @param space a pointer of the space struct
 * @param light a BOOL value that says if there any light or no
 * @return OK, if everything goes well or ERROR if there was some mistake
 */
STATUS space_set_light(Space *space, BOOL light);

/**
 * @brief it gets the value of the light
 * @author Oskar
 *
 * @param space a pointer of the space struct
