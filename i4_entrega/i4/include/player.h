 ...
 * @param inv the player's inventory with an objects' set
 ...
 *
 * @param player a pointer to the player
 * @param inv the inventory of the player to set
 * @return OK, if everything goes well or ERROR if there was some mistake
 */
...
/**
 * @brief Checks if an object is La inv of a player
 * @author Alexx
 * 
 * @param player a pointer to the player
 * @param object 
...
/**
 * @brief It gets if the player's inventory is empty
 * @author Luis
 *
 * @param player a pointer to the player
 * @return TRUE if the player's inventory is empty or if theres an error, FALSE in any other case
 */
