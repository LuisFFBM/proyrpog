...
/**
 * @test Test link_set_open
 * @pre Link initialized and status(ERROR)
 * @post link_set_open == OK && link.status == FALSE
 */
 ...
 * @post link_set_open == ERROR
 */
void test2_link_set_open();

/**
 * @test Test link_set_open
 * @pre Link initialized and status != TRUE && != FALSE && >0
 * @post link_set_open == ERROR
 */
...
/**
 * @test Test link_set_open
 * @pre Link uninitialized and FALSE
 * @post link_set_open == ERROR
 */
void test4_link_set_open();

/**
 * @test Test link_get_open
 * @pre Link initialized and FALSE
 * @post link_get_open == FALSE
 */
