...
{
    Player *p = NULL;
    Inventory *inv = inventory_create(6);
    PRINT_TEST_RESULT((p = player_create(10, "Rodrigo", 10, inv, 5)) != NULL);
    player_destroy(p);
}
...
void test2_player_create()
{
    Player *p = NULL;
    Inventory *inv = NULL;
    p = player_create(10, "Panda", 10, inv, 5);
...
void test3_player_create()
{
    ...
    Inventory *inv = inventory_create(6);
    p = player_create(10, "Panda", 10, inv, 5);
    PRINT_TEST_RESULT(player_get_id(p) == 10 && strcmp(player_get_name(p), "Panda") == 0 && player_get_location(p) == 10 && player_get_inventory(p) == inv && player_get_health(p) == 5);
    player_destroy(p);
}
...
void test1_player_set_id()
{
    Player *p = NULL;
    Inventory *inv = inventory_create(6);
    p = player_create(10, "Juan", 10, inv, 5);
    player_set_id(p, 5);
...
void test1_player_set_name()
{
    Player *p = NULL;
    Inventory *inv = inventory_create(6);
    p = player_create(10, "Cerda", 10, inv, 5);
...
void test1_player_set_location()
{
    Player *p = NULL;
    Inventory *inv = inventory_create(6);
    p = player_create(10, "Pedro", 10, inv, 5);
...
void test1_player_add_object_inventory()
{
    Player *p = NULL;
    Inventory *inv = inventory_create(6);
    p = player_create(10, "Asier", 10, inv, 5);
...
void test1_player_del_object_inventory()
{
    Player *p = NULL;
    Inventory *inv = inventory_create(6);
    p = player_create(10, "Luca", 10, inv, 5);
...
void test2_player_del_object_inventory()
{
    Player *p = NULL;
    Inventory *inv = inventory_create(6);
    p = player_create(10, "Johi", 10, inv, 5);
    player_add_object_inventory(p, 9);
...
void test1_player_get_objects_inventory()
{
    Player *p = NULL;
    Inventory *inv = inventory_create(6);
    p = player_create(10, "Kutxi", 10, inv, 5);
    player_add_object_inventory(p, 9);
...
void test1_player_id_in_inventory()
{
    Player *p = NULL;
    Inventory *inv = inventory_create(6);
    p = player_create(10, "Jimmy", 10, inv, 5);
    player_add_object_inventory(p, 9);
...
void test1_player_set_health()
{
    Player *p = NULL;
    Inventory *inv = inventory_create(2);
    p = player_create(10, "Jimmy", 10, inv, 6);
