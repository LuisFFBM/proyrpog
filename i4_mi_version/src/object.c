...
struct _Object
{
    ...
    char description[SIZE_LONG_DESC];   /*!< description of the object */
    BOOL movable;                       /*!< defines if it can be taken and drop  */        
    Id dependency;                      /*!< Id of the object to which it has a dependency */
    Id open;                            /*!< Id of the link it opens, NO_ID if it cannot open it */
    BOOL iluminate;                     /*!< if it can iluminate */
    BOOL turnedon;                      /*!< if is on or off */
};        
